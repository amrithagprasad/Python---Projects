...
#load images
bg = pygame.image.load('flappybird/img/bgpng.png')
ground_img = pygame.image.load('flappybird/img/ground.png')
button_img = pygame.image.load('flappybird/img/restart.png')
...
class Pipe(pygame.sprite.Sprite):
    def __init__(self, x, y, position):
        ...
        # 1 is from top -1 is from bottom
        if position == 1:
